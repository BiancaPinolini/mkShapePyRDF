...
aliases['lhe_mW1'] = {
    'expr': 'TMath::Sqrt(2. * Alt(LHEPart_pt,0,-9999.) * Alt(LHEPart_pt,1,-9999.) * (TMath::CosH(Alt(LHEPart_eta,0,-9999.) - Alt(LHEPart_eta,1,-9999.)) - TMath::Cos(Alt(LHEPart_phi,0,-9999.) - Alt(LHEPart_phi,1,-9999.))))',
    'samples': ['WWewk']
}

# and [2] [3] are the second W
aliases['lhe_mW2'] = {
    'expr': 'TMath::Sqrt(2. * Alt(LHEPart_pt,2,-9999.) * Alt(LHEPart_pt,3,-9999.) * (TMath::CosH(Alt(LHEPart_eta,2,-9999.) - Alt(LHEPart_eta,3,-9999.)) - TMath::Cos(Alt(LHEPart_phi,2,-9999.) - Alt(LHEPart_phi,3,-9999.))))',
    'samples': ['WWewk']
}