...
aliases['R_j2l1'] = {
        'expr': 'TMath::Sqrt(TMath::Power(CleanJet_eta[1]-Lepton_eta[0],2)-TMath::Power(CleanJet_phi[1]-Lepton_phi[0],2))',
        'samples': mc + ['DATA']
}

aliases['R_j1l2'] = {
        'expr': 'TMath::Sqrt(TMath::Power(CleanJet_eta[0]-Lepton_eta[1],2)-TMath::Power(CleanJet_phi[0]-Lepton_phi[1],2))',
        'samples': mc + ['DATA']
}

aliases['R_j2l2'] = {
        'expr': 'TMath::Sqrt(TMath::Power(CleanJet_eta[1]-Lepton_eta[1],2)-TMath::Power(CleanJet_phi[1]-Lepton_phi[1],2))',
        'samples': mc + ['DATA']
}
...
aliases['bVeto'] = {
    'expr': 'Sum(CleanJet_pt > 20. && AbsVec(CleanJet_eta) < 2.5 && Take(Jet_btagDeepB,CleanJet_jetIdx) > 0.4184) == 0'
}
aliases['bVetoT'] = {
    'expr': 'Sum(CleanJet_pt > 20. && AbsVec(CleanJet_eta) < 2.5 && Take(Jet_btagDeepB,CleanJet_jetIdx) >  0.7527  ) == 0'
}
# aliases['centralVeto'] = {
...
aliases['bVetoSF'] = {
    #'expr': 'TMath::Exp(Sum(LogVec((CleanJet_pt>20 && abs(CleanJet_eta)<2.5)*Jet_btagSF_shape[CleanJet_jetIdx]+1*(CleanJet_pt<20 || abs(CleanJet_eta)>2.5))))',
...
aliases['btag0SF'] = {
    #'expr': 'TMath::Exp(Sum(LogVec((CleanJet_pt>20 && CleanJet_pt<30 && AbsVec(CleanJet_eta)<2.5)*Jet_btagSF_shape[CleanJet_jetIdx]+1*(CleanJet_pt<20 || CleanJet_pt>30 || AbsVec(CleanJet_eta)>2.5))))',
...
aliases['btagnSF'] = {
    #'expr': 'TMath::Exp(Sum(LogVec((CleanJet_pt>30 && AbsVec(CleanJet_eta)<2.5)*Jet_btagSF_shape[CleanJet_jetIdx] + (CleanJet_pt<30 || AbsVec(CleanJet_eta)>2.5))))',
...
aliases['SFweight'] = {
    'expr': ' * '.join(['SFweight2l', 'LepSF2l__ele_' + eleWP + '__mu_' + muWP, 'LepWPCut', 'btagSF']), # removed PUJetSF (not in trees)
    'samples': mc
}
# variations
